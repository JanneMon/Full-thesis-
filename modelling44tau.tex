...
\begin{figure}[htbp]
    ...
    %\includegraphics[width=1\textwidth]{resolution_stages.png}
    	\makebox[\textwidth][c]{\includegraphics[width=1\textwidth]{freqsplot.eps}}%
...
\begin{figure}[htbp]
	...
	\makebox[\textwidth][c]{\includegraphics[width=1.5\textwidth]{scatter_final.eps}}%
...
\begin{figure}[htbp]
	\centering
	%\includegraphics[width=1\textwidth]{scatter_all_v2.eps}
	\makebox[\textwidth][c]{\includegraphics[width=1.3\textwidth]{final44tau.eps}}%
...
\begin{figure}[htbp]
	\centering
	%\includegraphics[width=1\textwidth]{scatter_all_v2.eps}
	\makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{final_pumped_freqsfit.eps}}%
...
\begin{figure}[htbp]
	\centering
	\makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{finalsuperstar_35.eps}}%
...
\begin{figure}[htbp]
	\centering
	\makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{finalsuperstar_7.eps}}%
